...
*/
Mat build_training_data( NN nn,   uint8_t **images_pxs , size_t *widths, size_t *heights , size_t img_count )
{
...
int main(int argc, char **argv)
{
    ...
    uint8_t *images[] = { img1_pixels, img2_pixels };
    size_t widths[] = {img1_width , img2_width }; 
    size_t heights[] = {img1_height , img2_height }; 

    Mat t = build_training_data( nn , images , widths , heights , 2 );
